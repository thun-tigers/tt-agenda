...
def validate_password_strength(password: str) -> str | None:
    """Return an error message for weak passwords, otherwise None."""
    if len(password or '') < PASSWORD_MIN_LENGTH:
        return f'Passwörter müssen mindestens {PASSWORD_MIN_LENGTH} Zeichen lang sein.'
    if password.lower() in {'password', 'passwort', 'admin', 'changeme'}:
        return 'Bitte verwende kein triviales Standardpasswort.'
    return None
